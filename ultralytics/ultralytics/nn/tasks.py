...
class BaseModel(nn.Module):
    ...
    def fuse(self, verbose=True):
        """
        Fuse the `Conv2d()` and `GroupNorm()` layers of the model into a single layer, in order to improve the
    ...
    def is_fused(self, thresh=10):
        """
        Check if the model has less than a certain threshold of GroupNorm layers.

        Args:
            thresh (int, optional): The threshold number of GroupNorm layers. Default is 10.
